...
versionConfigFile = "res/patch/jdnn_version_info.json"   #版本信息的配置文件路径
versionManifestPath = "res/patch/jdnn/version.manifest"  #由此脚本生成的version.manifest文件路径
projectManifestPath = "res/patch/jdnn/project.manifest"  #由此脚本生成的project.manifest文件路径
