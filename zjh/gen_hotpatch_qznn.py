...
assetsDir = {
    "searchDir" : ["src/app/game/qznn", "res/game/public", "res/game/qznn"],
    "ignoreDir" : ["cocos", "obj", "patch"]
}


versionConfigFile = "res/patch/qznn_version_info.json"   #版本信息的配置文件路径
versionManifestPath = "res/patch/qznn/version.manifest"  #由此脚本生成的version.manifest文件路径
projectManifestPath = "res/patch/qznn/project.manifest"  #由此脚本生成的project.manifest文件路径
